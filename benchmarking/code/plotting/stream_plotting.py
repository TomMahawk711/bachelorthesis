...
def _create_stream_plots_both():
    ...
    energies_r7, times_r7, copys_r7, scales_r7, adds_r7, triads_r7 = process(parameters_r7, benchmark_name, folder_name_r7, grouping_metric_r7, array_size=6400000)
    ...
    energies_i7, times_i7, copys_i7, scales_i7, adds_i7, triads_i7 = process(parameters_i7, benchmark_name, folder_name_i7, grouping_metric_i7, array_size=6400000)
...
def _create_stream_plots_i7_by_thread_count():
    ...
    energies_1600MHz, times_1600MHz, copys_1600MHz, scales_1600MHz, adds_1600MHz, triads_1600MHz = process(parameters, benchmark_name, folder_name, grouping_metric, frequency=1600, array_size=400000)
    energies_2100MHz, times_2100MHz, copys_2100MHz, scales_2100MHz, adds_2100MHz, triads_2100MHz = process(parameters, benchmark_name, folder_name, grouping_metric, frequency=2100, array_size=400000)
    energies_2600MHz, times_2600MHz, copys_2600MHz, scales_2600MHz, adds_2600MHz, triads_2600MHz = process(parameters, benchmark_name, folder_name, grouping_metric, frequency=2600, array_size=400000)
    energies_3100MHz, times_3100MHz, copys_3100MHz, scales_3100MHz, adds_3100MHz, triads_3100MHz = process(parameters, benchmark_name, folder_name, grouping_metric, frequency=3100, array_size=400000)
    energies_3600MHz, times_3600MHz, copys_3600MHz, scales_3600MHz, adds_3600MHz, triads_3600MHz = process(parameters, benchmark_name, folder_name, grouping_metric, frequency=3600, array_size=400000)
    energies_4100MHz, times_4100MHz, copys_4100MHz, scales_4100MHz, adds_4100MHz, triads_4100MHz = process(parameters, benchmark_name, folder_name, grouping_metric, frequency=4100, array_size=400000)
...
def _create_stream_plots_r7_by_thread_count():
    ...
    energies_2200MHz, times_2200MHz, copys_2200MHz, scales_2200MHz, adds_2200MHz, triads_2200MHz = process(parameters, benchmark_name, folder_name, grouping_metric, frequency=2200, array_size=1600000)
    energies_2800MHz, times_2800MHz, copys_2800MHz, scales_2800MHz, adds_2800MHz, triads_2800MHz = process(parameters, benchmark_name, folder_name, grouping_metric, frequency=2800, array_size=1600000)
    energies_3800MHz, times_3800MHz, copys_3800MHz, scales_3800MHz, adds_3800MHz, triads_3800MHz = process(parameters, benchmark_name, folder_name, grouping_metric, frequency=3800, array_size=1600000)
    ...
    create_scatter_plot(energies_data, "array size", "energy [J]", "energy consumption for different thread counts",
                        ["2200 MHz", "2800 MHz", "3800 MHz"], "upper center")
    create_scatter_plot(copys_data, "thread count", "bandwidth [GB/s]", "copy bandwidth for different thread counts",
                        ["3800 MHz"], "upper right")


if __name__ == "__main__":
    _create_stream_plots_r7_by_thread_count()
