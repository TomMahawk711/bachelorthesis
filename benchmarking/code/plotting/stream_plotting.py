...
def _create_stream_plots_i7_by_array_sizes():
    ...
    # create_scatter_plot(energies_data, "array size", "energy [J]", "energy consumption on different array sizes", ["1600", "2100MHz", "2600", "3100", "3600", "4100"],
    # "upper center")
...
def _create_stream_plots_by_frequencies():
    ...
    # create_scatter_plot(energies_data, "array size", "energy [J]", "energy consumption on different array sizes", ["1600", "2100MHz", "2600", "3100", "3600", "4100"],
    # "upper center")
    create_scatter_plot(copys_data, "array size", "bandwidth [MB/s]", "bandwidth on different array sizes", ["1600MHz", "2100MHz", "2600MHz", "3100MHz", "3600MHz", "4100MHz"], "upper left")


# TODO: slightly different scaling for adds and triads
...
if __name__ == "__main__":
    _create_stream_plots_by_thread_count()
