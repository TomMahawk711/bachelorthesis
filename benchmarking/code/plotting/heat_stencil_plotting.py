...
def _create_heat_stencil_plots_by_thread_counts():
    ...
    i7_energies, i7_times = process(parameters, benchmark_name, "i7-3770_new", grouping_metric, frequency=2100)
    ...
    create_scatter_plot(both_energies_data, "thread_count", "energy [J]", "energy consumption heat stencil", ["i7 3770", "R7 5800X"], "upper right")
...
def _create_heat_stencil_plots_by_frequencies():
    ...
    create_scatter_plot(both_speed_up, "frequency [MHz]", "speedup", "energy consumption heat stencil", ["i7 3770", "R7 5800X"], "upper left", x_ticks=i7_grouping_metric)
    create_scatter_plot(both_energies_data, "frequency [MHz]", "energy [J]", "energy consumption heat stencil", ["i7 3770", "R7 5800X"], "upper left", x_ticks=i7_grouping_metric)
    create_scatter_plot(both_times_data, "frequency [MHz]", "time [s]", "time heat stencil", ["i7 3770", "R7 5800X"], "upper right", x_ticks=i7_grouping_metric)
    create_scatter_plot(both_powers_data, "frequency [MHz]", "power [W]", "power consumption heat stencil", ["i7 3770", "R7 5800X"], "upper left", x_ticks=i7_grouping_metric)
    # create_scatter_plot(both_energies_times_data, "times", "energies", "energy/time heat stencil", ["i7 3770", "R7 5800X"], "upper right")
...
def _create_heat_stencil_plots_by_optimization():
    ...
    create_scatter_plot(both_speed_up, "optimization flag", "speed up", "speed up on different optimizations", ["i7 3770", "R7 5800X"], "upper left")
    create_scatter_plot(both_energies_data, "optimization flag", "energy [J]", "energy consumption on different optimizations", ["i7 3770", "R7 5800X"], "upper right")
    create_scatter_plot(both_times_data, "optimization flag", "time [s]", "time heat stencil", ["i7 3770", "R7 5800X"], "upper right")
    create_scatter_plot(both_powers_data, "optimization flag", "power [W]", "power consumption heat stencil", ["i7 3770", "R7 5800X"], "center left")
    # create_scatter_plot(both_energies_times_data, "times", "energies", "energy/time heat stencil", ["i7 3770", "R7 5800X"], "upper right")
