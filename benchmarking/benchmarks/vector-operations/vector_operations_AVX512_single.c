...
int main(int argc, char** argv){
	...
	float* a = (float*) memalign(sizeof(float)*16, sizeof(float)*size);
	float* b = (float*) memalign(sizeof(float)*16, sizeof(float)*size);
	float* c = (float*) memalign(sizeof(float)*16, sizeof(float)*size);
